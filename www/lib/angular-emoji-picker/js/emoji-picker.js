/**
 * Based on: https://github.com/newwaybrazil/angular-emoji-picker
 */

angular.module('templates-dist', [
    'templates/emoji-button-bootstrap.html',
    'templates/emoji-button-strap.html',
    'templates/emoji-button.html',
    'templates/emoji-popover-bootstrap.html',
    'templates/emoji-popover-strap.html',
    'templates/emoji-popover.html',
]);

angular.module('templates/emoji-button-bootstrap.html', []).run([
    '$templateCache',
    function ($templateCache) {
        $templateCache.put(
            ...
            '<span\n' +
                ...
                '   popover-title="{{ title }}" ng-bind-html="emoji | emojify"></span>\n' +
                ''
        );
    },
]);

angular.module('templates/emoji-button-strap.html', []).run([
    '$templateCache',
    function ($templateCache) {
        $templateCache.put(
            'templates/emoji-button-strap.html',
            '<span\n' +
                ...
                '   title="{{ title }}" ng-bind-html="emoji | emojify"></span\n' +
                ''
        );
    },
]);

angular.module('templates/emoji-button.html', []).run([
    '$templateCache',
    function ($templateCache) {
        $templateCache.put(
            'templates/emoji-button.html',
...
angular.module('templates/emoji-popover-bootstrap.html', []).run([
    '$templateCache',
    function ($templateCache) {
        $templateCache.put(
            'templates/emoji-popover-bootstrap.html',
...
angular.module('templates/emoji-popover-strap.html', []).run([
    '$templateCache',
    function ($templateCache) {
        $templateCache.put(
            'templates/emoji-popover-strap.html',
...
angular.module('templates/emoji-popover.html', []).run([
    '$templateCache',
    function ($templateCache) {
        $templateCache.put(
            'templates/emoji-popover.html',
...
angular.module('vkEmojiPicker').constant(
    'EmojiGroups',
    (function () {
        var faces = [
            'smile',
    ...
    function (emojiGroups, storage, vkEmojiTransforms) {
        ...
        return {
            ...
            link: function ($scope, element, attrs) {
                attrs.emoji = attrs.emoji || ':smiley:';

                $scope.caretPosition = -1;

                $scope.applyEmojisBlacklist = function (to) {
                    var hasRecentBan = false;
                    var banEmojisName = attrs.blacklist.match(/([a-zA-Z0-1]+)/gim);
                ...
                $scope.append = function (emoji) {
                    ...
                    const emojiChar = formatSelectedEmoji(emoji, outputFormat).trim();

                    if (attrs.replaceContent) {
                        $scope.model = emojiChar;
                    } else if ($scope.caretPosition > -1) {
                        var text = $scope.model;

                        $scope.model =
                            text.substring(0, $scope.caretPosition) +
                            emojiChar +
        ...
        link: function ($scope, element) {
            ...
            var rebindClick = function () {
                ...
                angular.forEach(emojis, function (emoji, key) {
                    var emojiElement = angular.element(emoji);
                    ionic.EventController.off('tap', function () {}, emojiElement[0]);
                    ionic.EventController.on(
                        'tap',
                        function () {
